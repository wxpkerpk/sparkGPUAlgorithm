package org.apache.spark.calabar.mllib.util
...
import org.apache.spark.mllib.linalg.{DenseVector, Matrices, Matrix, MatrixUDT, SparseVector, Vector, VectorUDT, Vectors}
