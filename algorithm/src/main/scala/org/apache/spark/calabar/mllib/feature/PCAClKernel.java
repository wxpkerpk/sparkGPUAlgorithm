...
public class PCAClKernel {
    ...
    private static PCAClKernel instance;
    public synchronized static PCAClKernel getInstance(){
        programSource= OpenCLCodeUtil.get(functionName);

        if(instance==null) instance=new PCAClKernel();
